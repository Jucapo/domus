...
function ExpandedHistory({ product, records, householdId }: { product: Product; records: PriceRecord[]; householdId: string }) {
  ...
  const stores: string[] = [...new Set(records.map((r) => r.store))].sort()
