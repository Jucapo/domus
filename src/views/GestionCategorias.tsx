...
type StyleModalState =
  | null
  | { mode: 'new'; icon: string; color: string }
  | { mode: 'edit'; cat: Category; icon: string; color: string; syncWithNameEdit: boolean }
...
export default function GestionCategorias() {
  ...
  const [styleModal, setStyleModal] = useState<StyleModalState>(null)
