...
export default function Gastos() {
  ...
  const { categoryData, grandTotal } = useMemo(() => {
    ...
    interface GastoProduct {
      ...
      quantity: number
      records: number
      purchases: GastoPurchase[]
    }
    interface GastoCategory {
      id: string
      name: string
      total: number
      products: Record<string, GastoProduct>
    }
    const catMap: Record<string, GastoCategory> = {}
    let total = 0
